...
export async function analyzeOrderHistory(detailedOrders, gotoItems = [], previousSchedule = []) {
    ...
    const MIN_CONFIDENCE = process.env.RECOMMENDATION_CONFIDENCE || 80;
...
4. **High Confidence Limit**: Only include items where your 'confidence' score is STRICTLY GREATER THAN ${MIN_CONFIDENCE}. If your certainty about an item's recurrence or identity is ${MIN_CONFIDENCE} or lower, do not include it in the output schedule list.
